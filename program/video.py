...
from config import BOT_USERNAME, IMG_2, IMG_5
...
@Client.on_message(command(["vplay", f"vplay@{BOT_USERNAME}", "فيديو"]) & other_filters)
...
@Client.on_message(command(["vstream", f"vstream@{BOT_USERNAME}", "مباشر"]) & other_filters)
