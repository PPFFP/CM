...
async def start_(client: Client, message: Message):
    await message.reply_photo(
        photo=f"{BOT_PHOTO}",
        caption=f"""⥁⁞ **مرحبا ضلعي: »「 [{query.message.chat.first_name}](tg://user?id={query.message.chat.id}) 」!**\n**⥁⁞ انا بوت «**روبلڪس**» استطيع**
            ...
            [
                [
                    InlineKeyboardButton(
                        "شراء البوت ", url="https://t.me/PPFFP",
                    )
                ],
                ...
                [
                    InlineKeyboardButton(
                        "الدعم الفني", url=f"https://t.me/{GROUP_SUPPORT}"
                    ),
                    InlineKeyboardButton(
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        ...
        caption=f"""**wellcome to source roblx **""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("قناة السورس الرسمية", url=f"https://t.me/EUUUJ"),
            ],
            [
                InlineKeyboardButton(
                    "مطور السورس", url=f"https://t.me/PPFFP"
                ),
            ],
            [
...
async def help(client: Client, message: Message):
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("𝗺𝗥.𝗕𝗮𝗞𝗥⁴⁰ᴷ", url=f"https://t.me/QABNADLIB"),
            ],
            [
                InlineKeyboardButton(
...
@Client.on_message(command(["uptime", f"uptime@{BOT_USERNAME}", "الوقت"]) & ~filters.edited)
